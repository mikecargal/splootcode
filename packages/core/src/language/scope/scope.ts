import { ComponentDefinition, FunctionDefinition, javascriptBuiltInGlobalFunctions, loadTypescriptTypeInfo, resolveMethodsFromTypeExpression, resolvePropertiesFromTypeExpression, TypeExpression, typeRegistry, VariableDefinition } from "../lib/loader.js";
import { SplootNode } from "../node.js";
import { loadPythonBuiltinFunctions } from "./python.js";
